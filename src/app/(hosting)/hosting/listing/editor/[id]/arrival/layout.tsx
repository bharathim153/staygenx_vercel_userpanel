...
import ArrivalSideBar from '@/app/components/ui/hosting/editlisting/sidebar/arrivalsidebar';
...
export default function RootLayout({
  ...
  return (
    <div className="flex h-[calc(100vh_-_80px)] w-full overflow-hidden">
      ...
      <div
        className={` w-full  lg:w-[65%] h-full overflow-auto scrollbar-hide flex`}
      >
        <div
